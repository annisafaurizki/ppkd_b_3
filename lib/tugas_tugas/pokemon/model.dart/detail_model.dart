...
//
//     final detailPoke = detailPokeFromJson(jsonString);

import 'dart:convert';

DetailPoke detailPokeFromJson(String str) =>
    DetailPoke.fromJson(json.decode(str));

String detailPokeToJson(DetailPoke data) => json.encode(data.toJson());
...
class DetailPoke {
  ...
  factory DetailPoke.fromJson(Map<String, dynamic> json) => DetailPoke(
